...
/**
 * Main processing class which should be used and extended. Data to be precessed
 * will be retrieved from ItemReader. After data has been processed the result
 * will be passed to ItemWriter.
 */
public abstract class ItemProcessing<I, O> {
	 ...
	 * @param item
	 *            Item to process
	 * @return result which will be passed to ItemWriter. Can be null if no
